...
//
#pragma CODE_SEG NON_BANKED
interrupt void porth_isr(void){ (void) PortH_Interrupt_handler (); }
#pragma CODE_SEG DEFAULT
...
//
#pragma CODE_SEG NON_BANKED
interrupt void ect_ch5_isr(void){ (void) Timer5_Interrupt(); }
#pragma CODE_SEG DEFAULT
...
//
#pragma CODE_SEG NON_BANKED
interrupt void ect_ch4_isr(void){ (void) Timer4_Interrupt(); }
#pragma CODE_SEG DEFAULT
